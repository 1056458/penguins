...
## The purpose of this document: contains/codes for functions to plot my statistical test (linear regression) as a figure and save it. 
...
plot_regression <- function(penguin_cleaner){
  penguin_cleaner %>%
    ...
    geom_smooth(method = "lm", colour = "#440154FF") +
    scale_color_manual(values = c("#31688EFF","#FDE725FF", "#35B779FF")) +
